...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('assets/images/admin-icon.png')}}" type="">
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-edit"></i> Tags <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{url('admin/category')}}">Tags List</a></li>
                                        <li><a href="{{url('admin/category/add')}}">Add Tag</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="sidebar-footer hidden-small">
                        ...
                        <a data-toggle="tooltip" data-placement="top" title="Logout" href="{{url('admin/login')}}">
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                ...
                                <div class="dropdown-menu dropdown-usermenu pull-right"
                                    ...
                                    <a class="dropdown-item" href="{{url('/admin/login')}}"><i
